...
// import iconMarker from "../assets/location.jpg"
...
function ComprarView() {
  ...
  const customIcon=new L.icon({
    iconUrl:"https://as1.ftcdn.net/v2/jpg/02/13/00/72/1000_F_213007261_8lZvqRL2hfHy9KiCh0mT7GhTm1CM5GE3.jpg",
    iconSize:[50,50]
  })
      ...
      <div className="row">
        ...
        <div className="col-12 col-lg-6">
          ...
          <form onSubmit={handleSubmit(recibirSubmit)}>
            ...
            <MapContainer center={[-12.1573446,-76.9747990902986]} zoom={17} style={{height:'400px'}}>
              {/*es la fuente de datos que necesita */}
              <TileLayer
                  attribution='&copy; <a href="http://osm.org/copyright%22%3EOpenStreetMap</a> contributors'
                  url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                />
              {/* <Marker 
                position={[-12.1573446,-76.9747990902986]}
